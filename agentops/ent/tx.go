...
func (tx *Tx) init() {
	tx.AgentEvent = NewAgentEventClient(tx.config)
	tx.AgentHandoff = NewAgentHandoffClient(tx.config)
...
// applies a query, for example: AgentEvent.QueryXXX(), the query will be executed
