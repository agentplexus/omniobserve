...
// function as AgentEvent mutator.
type AgentEventFunc func(context.Context, *ent.AgentEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AgentEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AgentEventMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AgentEventMutation", m)
}

// The AgentHandoffFunc type is an adapter to allow the use of ordinary
// function as AgentHandoff mutator.
type AgentHandoffFunc func(context.Context, *ent.AgentHandoffMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AgentHandoffFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AgentHandoffMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AgentHandoffMutation", m)
}
